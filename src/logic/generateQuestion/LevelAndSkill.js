...
export const skill = {
    ...
    multiply: {
        stage: {
            1: [1, 'multiply', 1], // Level 1
            2: [2, 'multiply', 1], // Level 2
            3: [2, 'multiply', 2], // Level 3
            4: [3, 'multiply', 2], // Level 4
    ...
    divide: {
        stage: {
            ...
            3: [2, 'divide', 2], // Level 4
            4: [3, 'divide', 2], // Level 4
            5: [3, 'divide', 3], // Level 5
            6: [4, 'divide', 3], // Level 6
